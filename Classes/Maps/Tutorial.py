...
class Tutorial:
    def start(self,frame,width,height):
        ...
        self.pickups.append(Pickup(Vector(1400,250), image_speed, 1, 1, "powerup", "speed"))
        self.pickups.append(Pickup(Vector(1500, 250), image_damage, 1, 1, "powerup", "damage"))
        self.pickups.append(Pickup(Vector(1400,250), image_speed, 1, 1, "powerup", "speed"))
        self.pickups.append(Pickup(Vector(1500, 250), image_damage, 1, 1, "powerup", "damage"))
        self.pickups.append(Pickup(Vector(1400,250), image_speed, 1, 1, "powerup", "speed"))
        self.pickups.append(Pickup(Vector(1500, 250), image_damage, 1, 1, "powerup", "damage"))
        self.pickups.append(Pickup(Vector(1400, 650), image_stamina, 1, 1, "powerup", "stamina"))
        self.pickups.append(Pickup(Vector(1450, 650), image_stamina, 1, 1, "powerup", "stamina"))
        self.pickups.append(Pickup(Vector(1500, 650), image_stamina, 1, 1, "powerup", "stamina"))
        self.pickups.append(Pickup(Vector(550, 650), hearts, 4, 1, "powerup", "heart"))
        self.pickups.append(Pickup(Vector(550, 250), hearts, 4, 1, "powerup", "heart"))
    ...
    def draw(self,canvas,offset,player,inventory):
        ...
        canvas.draw_text("These Powerups increase",(1250+offset.x,150+offset.y),40,"black")
        canvas.draw_text("attack damage and speed",(1250+offset.x,200+offset.y),40,"black")
        canvas.draw_text("These Powerups increase",(1250+offset.x,700+offset.y),40,"black")
        canvas.draw_text("your stamina regen rate",(1250+offset.x,750+offset.y),40,"black")