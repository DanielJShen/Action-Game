...
class Tutorial:
    def start(self,frame,width,height):
        ...
        self.pickups.append(Pickup(Vector(width/2,height/2)+Vector(600, -225), image_speed, 1, 1, "powerup", "speed"))
        self.pickups.append(Pickup(Vector(width/2,height/2)+Vector(700, -225), image_damage, 1, 1, "powerup", "damage"))
        self.pickups.append(Pickup(Vector(width/2,height/2)+Vector(600, -225), image_speed, 1, 1, "powerup", "speed"))
        self.pickups.append(Pickup(Vector(width/2,height/2)+Vector(700, -225), image_damage, 1, 1, "powerup", "damage"))
        self.pickups.append(Pickup(Vector(width/2,height/2)+Vector(600, -225), image_speed, 1, 1, "powerup", "speed"))
        self.pickups.append(Pickup(Vector(width/2,height/2)+Vector(700, -225), image_damage, 1, 1, "powerup", "damage"))
    ...
    def draw(self,canvas,offset,player,inventory):
        ...
        canvas.draw_text("These Powerups increase",(self.width/2+450+offset.x,self.height/2-300+offset.y),40,"black")
        canvas.draw_text("attack damage and speed",(self.width/2+450+offset.x,self.height/2-250+offset.y),40,"black")
        canvas.draw_text("These Powerups increase",(self.width/2+450+offset.x,self.height/2+250+offset.y),40,"black")
        canvas.draw_text("your stamina regen rate",(self.width/2+450+offset.x,self.height/2+300+offset.y),40,"black")